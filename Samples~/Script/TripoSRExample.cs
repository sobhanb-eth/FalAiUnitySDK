...
namespace TripoSR.SDK
{
    ...
    public class TripoSRExample : MonoBehaviour
    {
        ...
        [Header("Fal.ai API Key")] [SerializeField]
        ...
        private InputField imageUrlInputField; // Input field for image URL
        ...
        /// </remarks>
        [Header("Model Generation Settings")] [SerializeField]
        private bool
            removeBackground = true; // Whether to remove the background from the input image. Default value: true
        ...
        /// </summary>
        [SerializeField, OneDecimalSlider(0.5f, 1f)]
        private float foregroundRatio = 0.9f; // Ratio of the foreground image to the original image. Default value: 0.9
        ...
        private int
            mcResolution = 256; // Resolution of the marching cubes. Above 512 is not recommended. Default value: 256
